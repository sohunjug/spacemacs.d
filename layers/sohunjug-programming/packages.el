; -*- lexical-binding: t -*-
;;; packages.el --- sohunjug Layer packages File for Spacemacs
;;
...
(setq sohunjug-programming-packages
      '(
        css-mode
        paredit
        lispy
...
(defun sohunjug-programming/post-init-typescript-mode ()
  (add-hook 'typescript-mode-hook 'my-ts-mode-hook))

(defun sohunjug-programming/post-init-lsp-mode ()
  (progn
    ...
    (add-hook 'lsp-after-open-hook 'sohunjug-refresh-imenu-index)
...
(defun sohunjug-programming/init-compile-dwim ()
  (use-package compile-dwim
    :commands (compile-dwim-run compile-dwim-compile)
    :init))


(defun sohunjug-programming/post-init-robe ()
  (progn
    (add-hook 'inf-ruby-mode-hook 'spacemacs/toggle-auto-completion-on)
    (defun sohunjug/ruby-send-current-line (&optional print)
    ...
    (defun sohunjug/ruby-send-current-line-and-go ()
      (interactive)
      (sohunjug/ruby-send-current-line)
      (ruby-switch-to-inf t))

    (defun sohunjug/start-inf-ruby-and-robe ()
      (interactive)
    ...
    (dolist (mode '(ruby-mode enh-ruby-mode))
      (spacemacs/set-leader-keys-for-major-mode mode
        "sb" 'ruby-send-block
        "sB" 'ruby-send-buffer
        "sl" 'sohunjug/ruby-send-current-line
        "sL" 'sohunjug/ruby-send-current-line-and-go
        "sI" 'sohunjug/start-inf-ruby-and-robe))))

(defun sohunjug-programming/init-caps-lock ()
  (use-package caps-lock
    :init
    (progn
      (bind-key* "s-e" 'caps-lock-mode))))

(defun sohunjug-programming/init-editorconfig ()
  (use-package editorconfig
    :init
    (progn
      (defun conditional-enable-editorconfig ()
        (if (and (sohunjug/git-project-root)
                 (locate-dominating-file default-directory ".editorconfig"))
            (editorconfig-apply)))
      (add-hook 'prog-mode-hook 'conditional-enable-editorconfig))))

(defun sohunjug-programming/post-init-cider ()
  (setq cider-cljs-lein-repl
        "(do (require 'figwheel-sidecar.repl-api)
           (figwheel-sidecar.repl-api/start-figwheel!)
           (figwheel-sidecar.repl-api/cljs-repl))")

  (defun sohunjug/cider-figwheel-repl ()
    (interactive)
    (save-some-buffers)
  ...
  (global-set-key (kbd "C-c C-f") #'sohunjug/cider-figwheel-repl))

(defun sohunjug-programming/post-init-graphviz-dot-mode ()
  (with-eval-after-load 'graphviz-dot-mode
      (require 'company-keywords)
      (push '(graphviz-dot-mode  "digraph" "node" "shape" "subgraph" "label" "edge" "bgcolor" "style" "record") company-keywords-alist)))

(defun sohunjug-programming/post-init-dumb-jump ()
...
(defun sohunjug-programming/post-init-clojure-mode ()
  )

(defun sohunjug-programming/post-init-emacs-lisp ()
    (remove-hook 'emacs-lisp-mode-hook 'auto-compile-mode))

(defun sohunjug-programming/post-init-python ()
  (add-hook 'python-mode-hook #'(lambda () (modify-syntax-entry ?_ "w")))
  ;; if you use pyton3, then you could comment the following line
  (setq python-shell--interpreter "python3"))

(defun sohunjug-programming/post-init-js-doc ()
  (setq js-doc-mail-address "sohunjug@gmail.com"
        js-doc-author (format "sohunjug <%s>" js-doc-mail-address)
        js-doc-url "http://sohunjug.com"
        js-doc-license "MIT")

  )


(defun sohunjug-programming/init-ctags-update ()
...
;; (defun sohunjug-programming/init-js-comint ()
...
(defun sohunjug-programming/post-init-web-mode ()
...
(defun sohunjug-programming/post-init-yasnippet ()
  (progn
    ...
    (spacemacs/add-to-hooks 'sohunjug/load-yasnippet '(prog-mode-hook
                                                            markdown-mode-hook
                                                            org-mode-hook))
    ))

(defun sohunjug-programming/post-init-racket-mode ()
  (progn
...
(defun sohunjug-programming/post-init-json-mode ()
...
(defun sohunjug-programming/init-flycheck-package ()
  (use-package flycheck-package))

(defun sohunjug-programming/init-lispy ()
  (use-package lispy
    :defer t
    :init
    (progn
...
(defun sohunjug-programming/init-cmake-font-lock ()
  (use-package cmake-font-lock
    :defer t))

(defun sohunjug-programming/init-google-c-style ()
  (use-package google-c-style
    :init (add-hook 'c-mode-common-hook 'google-set-c-style)))

(defun sohunjug-programming/post-init-cmake-mode ()
  (progn
...
(defun sohunjug-programming/post-init-flycheck ()
...
(defun sohunjug-programming/post-init-eldoc ()
  (setq eldoc-idle-delay 0.4))


(defun sohunjug-programming/post-init-js2-refactor ()
  (progn
...
(defun sohunjug-programming/post-init-js2-mode ()
  (progn
...
(defun sohunjug-programming/post-init-css-mode ()
  (progn
...
(defun sohunjug-programming/post-init-tagedit ()
  (add-hook 'web-mode-hook (lambda () (tagedit-mode 1))))

;; For each extension, define a function sohunjug/init-<extension-name>
;;
(defun sohunjug-programming/init-doxymacs ()
  "Initialize doxymacs"
...
(defun sohunjug-programming/init-nodejs-repl-eval ()
...
(defun sohunjug-programming/post-init-lua-mode ()
  (progn
...
(defun sohunjug-programming/post-init-cc-mode ()
  (progn
...
(defun sohunjug-programming/init-flycheck-clojure ()
  (use-package flycheck-clojure
    :defer t
    :init
    (eval-after-load 'flycheck '(flycheck-clojure-setup))))

(defun sohunjug-programming/post-init-ycmd ()
  (progn
    (setq ycmd-tag-files 'auto)
    (setq ycmd-request-message-level -1)
    (set-variable 'ycmd-server-command `("python3" ,(expand-file-name "~/.ycmd/ycmd/__main__.py")))
    ...
    ;; (sohunjug|toggle-company-backends company-ycmd)
    (eval-after-load 'ycmd
      '(spacemacs|hide-lighter ycmd-mode))

    (spacemacs/set-leader-keys-for-major-mode 'c-mode
      "tb" 'sohunjug/company-toggle-company-ycmd)
    (spacemacs/set-leader-keys-for-major-mode 'c++-mode
      "tb" 'sohunjug/company-toggle-company-ycmd)))

;; when many project has the need to use tags, I will give etags-table and etags-update a try
(defun sohunjug-programming/init-etags-select ()
...
(defun sohunjug-programming/init-gulpjs ()
  (use-package gulpjs
    :init
    (progn
      (defun sohunjug/build-engine ()
        (interactive)
        (gulpjs-start-task-with-file-name "~/Github/fireball/app.js"))

      (spacemacs/set-leader-keys "ags" 'gulpjs-start-task)
      (spacemacs/set-leader-keys "agS" 'sohunjug/build-engine)
      (spacemacs/set-leader-keys "agr" 'gulpjs-restart-task))))


(defun sohunjug-programming/init-paredit ()
  (use-package paredit
...
(defun sohunjug-programming/post-init-company ()
  (progn
...
(defun sohunjug-programming/post-init-company-c-headers ()
  (progn
    ...
    (setq company-c-headers-path-user
          (quote
           ("/Users/sohunjug/Documents/Code/kayak/include" "/Users/sohunjug/Documents/Code/sohunjug/cplus/include" ".")))))
