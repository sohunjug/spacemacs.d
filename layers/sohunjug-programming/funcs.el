...
(defun sohunjug/comment-box (b e)
...
(defun sohunjug/js2-which-function ()
...
(defun sohunjug/run-current-file ()
...
(defun my-setup-develop-environment ()
  (interactive)
  (when (my-project-name-contains-substring "sohunjug")
    (cond
     ((my-project-name-contains-substring "code")
      ;; C++ project don't need html tags
      (setq tags-table-list (list (my-create-tags-if-needed "~/Documents/Code"))))
     ((my-project-name-contains-substring "Github/fireball")
      (message "load tags for fireball engine repo...")
      ;; html project donot need C++ tags
      (setq tags-table-list (list (my-create-tags-if-needed "~/Code/sohunjug/Github/")))))))

(defun sohunjug-refresh-imenu-index ()
  (interactive)
