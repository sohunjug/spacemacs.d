...
(defconst sohunjug-ui-packages
  '(
    (sohunjug-mode-line :location built-in)
    diminish
    popwin
    (whitespace :location built-in)
    ;; hl-anything performance is very slow...
    ;; hl-anything
    ;; if you wnat to use spaceline, please comment out sohunjug-mode-line
    ;; spaceline
    ;; beacon
    ;; evil-vimish-fold
    ;; company-box
...
(defun sohunjug-ui/init-sohunjug-mode-line ()
  (defun sohunjug/display-mode-indent-width ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 " "
                 '(:eval (sohunjug/modeline--evil-substitute))
                 '(:eval (sohunjug/update-persp-name))
                 ...
                 '(:eval (sohunjug/display-mode-indent-width))
                 ;; line and column
...
(defun sohunjug-ui/post-init-diminish ()
  (progn
...
(defun sohunjug-ui/post-init-spaceline ()
...
This segment overrides the modeline functionality of `org-mode-line-string'."
      ...
      (setq-default mode-line-format '("%e" (:eval (spaceline-ml-sohunjug))))
      )))

(defun sohunjug-ui/init-company-box ()
...
(defun sohunjug-ui/init-evil-vimish-fold ()
...
(defun sohunjug-ui/post-init-hl-anything ()
  (progn
...
(defun sohunjug-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
...
(defun sohunjug-ui/post-init-popwin ()
  (progn
    ;FIXME: 
    ;; (push "*sohunjug/run-current-file output*" popwin:special-display-config)
    (delete "*Async Shell Command*" popwin:special-display-config)))

(defun sohunjug-ui/post-init-whitespace ()
  (progn
