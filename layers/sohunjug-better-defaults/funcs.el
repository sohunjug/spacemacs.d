...
(defun sohunjug/smart-open-line ()
...
(defun sohunjug/rename-file-and-buffer ()
...
(defun sohunjug/yank-to-end-of-line ()
  "Yank to end of line."
  (interactive)
...
(defun sohunjug/dired-do-command (command)
...
(defun sohunjug/dired-up-directory()
  "goto up directory and resue buffer"
  (interactive)
  (find-alternate-file ".."))

(defun sohunjug/insert-space-after-point ()
  (interactive)
