...
(defun sohunjug/cleanup-recentf ()
  (progn
    (and (fboundp 'recentf-cleanup)
         (recentf-cleanup))))

(add-hook 'kill-emacs-hook #'sohunjug/cleanup-recentf)
...
(defun sohunjug/stop-using-minibuffer ()
  "kill the minibuffer"
  (when (and (>= (recursion-depth) 1) (active-minibuffer-window))
    (abort-recursive-edit)))

(add-hook 'mouse-leave-buffer-hook 'sohunjug/stop-using-minibuffer)
...
(defun sohunjug-ag-edit (function)
...
;; (defun sohunjug-after-ag-edit (function)
;;   (ivy-occur-grep-mode))

(advice-add 'helm-ag--edit :before #'sohunjug-ag-edit)
;; (advice-add 'helm-ag--edit :after #'sohunjug-after-ag-edit)
