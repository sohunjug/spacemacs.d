; -*- lexical-binding: t -*-
;;; packages.el --- sohunjug-ui layer packages file for Spacemacs.
;;
...
(defconst sohunjug-org-packages
  '(
...
(defun sohunjug-org/init-cal-china-x ()
...
(defun sohunjug-org/init-org-super-agenda ()
...
(defun sohunjug-org/post-init-org-superstar ()
  (progn
    (setq org-superstar-headline-bullets-list '("☰" "☷" "☯" "☭"))
    (setq org-ellipsis " ▼ ")
    ))

(defun sohunjug-org/post-init-evil-org ()
...
(defun sohunjug-org/post-init-org-pomodoro ()
  (sohunjug/pomodoro-notification))

;;In order to export pdf to support Chinese, I should install Latex at here: https://www.tug.org/mactex/
;; http://freizl.github.io/posts/2012-04-06-export-orgmode-file-in-Chinese.html
;;http://stackoverflow.com/questions/21005885/export-org-mode-code-block-and-result-with-different-styles
(defun sohunjug-org/post-init-org ()
  ...
  (with-eval-after-load 'org
    (progn
      ...
      (defun sohunjug/org-return (&optional indent)
      ...
      (setq org-capture-templates
            '(("t" "Todo" entry (file+headline org-agenda-file-gtd "Workspace")
              ...
              ("c" "Chrome" entry (file+headline org-agenda-file-note "Quick notes")
               "* TODO [#C] %?\n %(sohunjug/retrieve-chrome-current-tab-url)\n %i\n %U"
               :empty-lines 1)
...
See `org-capture-templates' for more information."
      ...
      (setq org-agenda-custom-commands
            '(
              ...
              ("pl" tags-todo "PROJECT+DREAM+CATEGORY=\"sohunjug\"")
              ("W" "Weekly Review"
      ...
      (defvar sohunjug-website-html-preamble
        "<div class='nav'>
<ul>
<li><a href='http://sohunjug.com'>博客</a></li>
<li><a href='/index.html'>Wiki目录</a></li>
</ul>
</div>")
      (defvar sohunjug-website-html-blog-head
    ...
    <link rel=\"stylesheet\" type=\"text/css\" href=\"/css/worg.css\"/>")
      (setq org-publish-project-alist
            `(
              ("blog-notes"
               ...
               :recursive t
               :html-head , sohunjug-website-html-blog-head
               ...
               :section-numbers nil
               :html-preamble ,sohunjug-website-html-preamble
               :author "sohunjug"
               :email "sohunjug@gmail.com"
      ...
      (add-hook 'org-after-todo-statistics-hook 'sohunjug/org-summary-todo)
      ;; used by sohunjug/org-clock-sum-today-by-tags
...
(defun sohunjug-org/init-org-mac-link ()
...
(defun sohunjug-org/post-init-ox-reveal ()
  (setq org-reveal-root "file:///Users/sohunjug/.emacs.d/reveal-js"))


(defun sohunjug-org/init-org-tree-slide ()
  (use-package org-tree-slide
    :init
    (spacemacs/set-leader-keys "oto" 'org-tree-slide-mode)))


(defun sohunjug-org/init-org-download ()
  (use-package org-download
    :defer t
    :init
    (org-download-enable)))

(defun sohunjug-org/init-plain-org-wiki ()
  (use-package plain-org-wiki
    :init
    (setq pow-directory "~/Documents/org-notes")))

(defun sohunjug-org/init-ob-typescript ()
  (use-package ob-typescript
    :init))

(defun sohunjug-org/init-worf ()
  (use-package worf
    :defer t
    :init
    (add-hook 'org-mode-hook 'worf-mode)))

(defun sohunjug-org/post-init-deft ()
  (progn
...
(defun sohunjug-org/init-sound-wav ()
